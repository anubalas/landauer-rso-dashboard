...
export default function ActionCenterPanel({ isOpen, criticalTasks, onClose }: Props) {
    ...
    >
      ...
      <div className="px-8 py-6">
        ...
        <div className="flex items-center gap-4 bg-[#fefce8] border border-yellow-200 rounded-lg px-5 py-3.5 mb-7">
          ...
          <p className="text-[13px] text-gray-800 flex-1">
          ...
          <button className="flex items-center gap-2 bg-orange-500 hover:bg-orange-600 text-white font-semibold text-[13px] px-4 py-2 rounded-md flex-shrink-0 border-0 cursor-pointer transition-colors">
        ...
        <div className="flex gap-5 items-start">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-2 mb-5 flex-wrap">
              ...
              {/* Assignees — floating label + open/close dropdown */}
              <div
                className="relative mt-4"
                onClick={e => e.stopPropagation()}
              >
                <span className="absolute -top-4 left-3 text-[11px] text-gray-500 leading-none">
                  Assignees
                </span>
                <button
                ...
                >
                  ...
                  <svg
                    ...
                    strokeWidth={2.5}
                    stroke="currentColor"
                    className={`w-3 h-3 flex-shrink-0 text-gray-600 transition-transform ${assigneesOpen ? 'rotate-180' : ''}`}
                  >
                    <path strokeLinecap="round" strokeLinejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
                  </svg>
                </button>
              ...
              {/* Statuses — floating label + selected value */}
              <div
                className="relative mt-4"
                onClick={e => e.stopPropagation()}
              >
                ...
                >
                  <span className="truncate">
                    {selectedStatus !== 'All' ? selectedStatus : 'Statuses'}
                  </span>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    ...
                    strokeWidth={2.5}
                    stroke="currentColor"
                    className={`w-3 h-3 flex-shrink-0 text-gray-600 transition-transform ${statusesOpen ? 'rotate-180' : ''}`}
                  >
                    <path strokeLinecap="round" strokeLinejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
                  </svg>
                </button>
          ...
          <div className="w-72 flex-shrink-0">
            <div className="bg-white border border-gray-200 rounded-xl p-4">
              ...
              {/* "Task Calendar" label + Today button */}
                ...
                {calDays.map(day => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {/* Orange dot for dates with tasks (skip today — its circle already signals it) */}
